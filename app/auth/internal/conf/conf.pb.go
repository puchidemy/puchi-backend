...
type Data struct {
	...
	Valkey        *Data_Valkey           `protobuf:"bytes,2,opt,name=valkey,proto3" json:"valkey,omitempty"`
...
func (x *Data) GetValkey() *Data_Valkey {
	if x != nil {
		return x.Valkey
	}
	return nil
...
func (x *Auth) GetCorsAllowedOrigins() []string {
	if x != nil {
...
func (x *Data_Valkey) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
// Deprecated: Use Data_Valkey.ProtoReflect.Descriptor instead.
func (*Data_Valkey) Descriptor() ([]byte, []int) {
...
func (x *Data_Valkey) GetDb() int32 {
	if x != nil {
		return x.Db
	}
	return 0
...
func (x *Data_Valkey) GetPoolSize() int32 {
	if x != nil {
		return x.PoolSize
	}
	return 0
...
const file_conf_conf_proto_rawDesc = "" +
	...
	"\x04GRPC\x12\x12\n" +
	"\x04addr\x18\x01 \x01(\tR\x04addr\x123\n" +
	"\atimeout\x18\x02 \x01(\v2\x19.google.protobuf.DurationR\atimeout\"\xa8\x02\n" +
	"\x04Data\x12/\n" +
	"\bdatabase\x18\x01 \x01(\v2\x13.conf.Data.DatabaseR\bdatabase\x12)\n" +
	"\x06valkey\x18\x02 \x01(\v2\x11.conf.Data.ValkeyR\x06valkey\x12#\n" +
	"\x04nats\x18\x03 \x01(\v2\x0f.conf.Data.NATSR\x04nats\x1a:\n" +
	"\bDatabase\x12\x16\n" +
	"\x06driver\x18\x01 \x01(\tR\x06driver\x12\x16\n" +
	"\x06source\x18\x02 \x01(\tR\x06source\x1aI\n" +
	"\x06Valkey\x12\x12\n" +
	"\x04addr\x18\x01 \x01(\tR\x04addr\x12\x0e\n" +
	"\x02db\x18\x02 \x01(\x05R\x02db\x12\x1b\n" +
	"\tpool_size\x18\x03 \x01(\x05R\bpoolSize\x1a\x18\n" +
	"\x04NATS\x12\x10\n" +
