...
func (x *Bootstrap) GetMedia() *Media {
	if x != nil {
		return x.Media
	}
	return nil
...
type Auth struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	AuthServiceUrl string                 `protobuf:"bytes,1,opt,name=auth_service_url,json=authServiceUrl,proto3" json:"auth_service_url,omitempty"`
...
func (x *Auth) GetAuthServiceUrl() string {
	if x != nil {
		return x.AuthServiceUrl
	}
	return ""
}

func (x *Auth) GetPublicPaths() []string {
	if x != nil {
...
type Media struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Storage       *Media_Storage         `protobuf:"bytes,1,opt,name=storage,proto3" json:"storage,omitempty"`
	Upload        *Media_Upload          `protobuf:"bytes,2,opt,name=upload,proto3" json:"upload,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Media) GetStorage() *Media_Storage {
	if x != nil {
		return x.Storage
	}
	return nil
...
func (x *Media) GetUpload() *Media_Upload {
	if x != nil {
		return x.Upload
	}
	return nil
...
func (x *Media_Storage) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Media_Storage) ProtoMessage() {}

func (x *Media_Storage) ProtoReflect() protoreflect.Message {
	mi := &file_conf_conf_proto_msgTypes[9]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Media_Storage.ProtoReflect.Descriptor instead.
func (*Media_Storage) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{4, 0}
}

func (x *Media_Storage) GetEndpoint() string {
	if x != nil {
		return x.Endpoint
	}
	return ""
...
func (x *Media_Storage) GetAccessKeyId() string {
	if x != nil {
...
func (x *Media_Storage) GetSecretAccessKey() string {
	if x != nil {
...
func (x *Media_Storage) GetBucket() string {
	if x != nil {
		return x.Bucket
	}
	return ""
...
func (x *Media_Storage) GetUseSsl() bool {
	if x != nil {
		return x.UseSsl
	}
	return false
...
type Media_Upload struct {
	...
	PresignedUrlTtl int64                  `protobuf:"varint,2,opt,name=presigned_url_ttl,json=presignedUrlTtl,proto3" json:"presigned_url_ttl,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}

func (x *Media_Upload) Reset() {
	*x = Media_Upload{}
...
func (x *Media_Upload) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Media_Upload) ProtoMessage() {}

func (x *Media_Upload) ProtoReflect() protoreflect.Message {
	mi := &file_conf_conf_proto_msgTypes[10]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Media_Upload.ProtoReflect.Descriptor instead.
func (*Media_Upload) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{4, 1}
}

func (x *Media_Upload) GetMaxSizeBytes() int64 {
	if x != nil {
...
func (x *Media_Upload) GetPresignedUrlTtl() int64 {
	if x != nil {
		return x.PresignedUrlTtl
	}
	return 0
}
...
const file_conf_conf_proto_rawDesc = "" +
	...
	"\x05media\x18\x03 \x01(\v2\x11.kratos.api.MediaR\x05media\x12$\n" +
	"\x04auth\x18\x04 \x01(\v2\x10.kratos.api.AuthR\x04auth\"S\n" +
	"\x04Auth\x12(\n" +
	"\x10auth_service_url\x18\x01 \x01(\tR\x0eauthServiceUrl\x12!\n" +
	"\fpublic_paths\x18\x02 \x03(\tR\vpublicPaths\"\xb8\x02\n" +
	"\x06Server\x12+\n" +
...
var file_conf_conf_proto_goTypes = []any{
	...
	(*Media_Storage)(nil),       // 9: kratos.api.Media.Storage
	(*Media_Upload)(nil),        // 10: kratos.api.Media.Upload
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	4,  // 2: kratos.api.Bootstrap.media:type_name -> kratos.api.Media
	1,  // 3: kratos.api.Bootstrap.auth:type_name -> kratos.api.Auth
	...
	9,  // 8: kratos.api.Media.storage:type_name -> kratos.api.Media.Storage
	10, // 9: kratos.api.Media.upload:type_name -> kratos.api.Media.Upload
