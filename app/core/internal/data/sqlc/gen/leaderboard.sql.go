...
const upsertSocialWeeklyXP = `-- name: UpsertSocialWeeklyXP :exec
...
type UpsertSocialWeeklyXPParams struct {
	UserID    string      `db:"user_id"`
	WeekStart pgtype.Date `db:"week_start"`
	WeeklyXp  int32       `db:"weekly_xp"`
}

func (q *Queries) UpsertSocialWeeklyXP(ctx context.Context, arg UpsertSocialWeeklyXPParams) error {
	_, err := q.db.Exec(ctx, upsertSocialWeeklyXP, arg.UserID, arg.WeekStart, arg.WeeklyXp)
	return err
}
