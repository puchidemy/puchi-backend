...
type Querier interface {
	...
	ListDailyActivityRange(ctx context.Context, arg ListDailyActivityRangeParams) ([]CoreDailyActivity, error)
	...
	ListWeeklyXPHistory(ctx context.Context, arg ListWeeklyXPHistoryParams) ([]CoreXpHistory, error)
	SearchUsers(ctx context.Context, arg SearchUsersParams) ([]SearchUsersRow, error)
	Unfollow(ctx context.Context, arg UnfollowParams) error
	UpdateAvatarKey(ctx context.Context, arg UpdateAvatarKeyParams) (CoreUser, error)
