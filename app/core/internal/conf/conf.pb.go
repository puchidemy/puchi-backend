...
type Auth struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Zitadel       *Auth_Zitadel          `protobuf:"bytes,1,opt,name=zitadel,proto3" json:"zitadel,omitempty"`
...
func (x *Auth) GetZitadel() *Auth_Zitadel {
	if x != nil {
		return x.Zitadel
	}
	return nil
...
func (x *Auth_Zitadel) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Auth_Zitadel) ProtoMessage() {}

func (x *Auth_Zitadel) ProtoReflect() protoreflect.Message {
	mi := &file_conf_conf_proto_msgTypes[8]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Auth_Zitadel.ProtoReflect.Descriptor instead.
func (*Auth_Zitadel) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{3, 0}
}

func (x *Auth_Zitadel) GetIssuerUrl() string {
	if x != nil {
		return x.IssuerUrl
	}
	return ""
...
func (x *Auth_Zitadel) GetJwksUrl() string {
	if x != nil {
		return x.JwksUrl
	}
	return ""
...
const file_conf_conf_proto_rawDesc = "" +
	...
	"\rwrite_timeout\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\fwriteTimeout\"\xa2\x01\n" +
	"\x04Auth\x122\n" +
	"\azitadel\x18\x01 \x01(\v2\x18.kratos.api.Auth.ZitadelR\azitadel\x12!\n" +
	"\fpublic_paths\x18\x02 \x03(\tR\vpublicPaths\x1aC\n" +
	"\aZitadel\x12\x1d\n" +
	"\n" +
	"issuer_url\x18\x01 \x01(\tR\tissuerUrl\x12\x19\n" +
	"\bjwks_url\x18\x02 \x01(\tR\ajwksUrlB\x1dZ\x1btmp_core/internal/conf;confb\x06proto3"
...
var file_conf_conf_proto_goTypes = []any{
	...
	(*Auth_Zitadel)(nil),        // 8: kratos.api.Auth.Zitadel
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	8,  // 7: kratos.api.Auth.zitadel:type_name -> kratos.api.Auth.Zitadel
