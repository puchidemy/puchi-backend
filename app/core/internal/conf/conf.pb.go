...
type Auth struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Supertokens   *Auth_Supertokens      `protobuf:"bytes,1,opt,name=supertokens,proto3" json:"supertokens,omitempty"`
...
func (x *Auth) GetSupertokens() *Auth_Supertokens {
	if x != nil {
		return x.Supertokens
	}
	return nil
}
...
type Auth_Supertokens struct {
	...
	CookieSecure  bool                   `protobuf:"varint,4,opt,name=cookie_secure,json=cookieSecure,proto3" json:"cookie_secure,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *Auth_Supertokens) Reset() {
	*x = Auth_Supertokens{}
...
func (x *Auth_Supertokens) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Auth_Supertokens) ProtoMessage() {}

func (x *Auth_Supertokens) ProtoReflect() protoreflect.Message {
	mi := &file_internal_conf_conf_proto_msgTypes[8]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Auth_Supertokens.ProtoReflect.Descriptor instead.
func (*Auth_Supertokens) Descriptor() ([]byte, []int) {
	return file_internal_conf_conf_proto_rawDescGZIP(), []int{3, 0}
}

func (x *Auth_Supertokens) GetConnectionUri() string {
	if x != nil {
...
func (x *Auth_Supertokens) GetApiKey() string {
	if x != nil {
		return x.ApiKey
	}
	return ""
...
func (x *Auth_Supertokens) GetCookieDomain() string {
	if x != nil {
...
func (x *Auth_Supertokens) GetCookieSecure() bool {
	if x != nil {
...
const file_internal_conf_conf_proto_rawDesc = "" +
	...
	"\bDatabase\x12\x16\n" +
	"\x06source\x18\x01 \x01(\tR\x06source\x1a\xb3\x01\n" +
	"\x05Redis\x12\x18\n" +
	"\anetwork\x18\x01 \x01(\tR\anetwork\x12\x12\n" +
	"\x04addr\x18\x02 \x01(\tR\x04addr\x12<\n" +
	"\fread_timeout\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\vreadTimeout\x12>\n" +
	"\rwrite_timeout\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\fwriteTimeout\"\x83\x02\n" +
	"\x04Auth\x12>\n" +
	"\vsupertokens\x18\x01 \x01(\v2\x1c.kratos.api.Auth.SupertokensR\vsupertokens\x12!\n" +
	"\fpublic_paths\x18\x02 \x03(\tR\vpublicPaths\x1a\x97\x01\n" +
	"\vSupertokens\x12%\n" +
	"\x0econnection_uri\x18\x01 \x01(\tR\rconnectionUri\x12\x17\n" +
	"\aapi_key\x18\x02 \x01(\tR\x06apiKey\x12#\n" +
	"\rcookie_domain\x18\x03 \x01(\tR\fcookieDomain\x12#\n" +
	"\rcookie_secure\x18\x04 \x01(\bR\fcookieSecureB\x1dZ\x1btmp_core/internal/conf;confb\x06proto3"
...
var file_internal_conf_conf_proto_goTypes = []any{
	...
	(*Auth_Supertokens)(nil),    // 8: kratos.api.Auth.Supertokens
...
var file_internal_conf_conf_proto_depIdxs = []int32{
	...
	8,  // 7: kratos.api.Auth.supertokens:type_name -> kratos.api.Auth.Supertokens
